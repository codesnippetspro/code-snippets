...
/**
 * Test double for {@see Insert_Headers_And_Footers_Plugin_Importer} (WPCode).
 *
 * Always reports the source plugin as active and returns whatever rows the test assigns to
 * the public {@see self::$rows} property, so WPCode scanner tests do not need a real install.
 */
