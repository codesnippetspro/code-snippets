...
### Importing snppets from an XML file
![Importing snppets from an XML file](https://raw.github.com/bungeshea/code-snippets/master/screenshot-5.jpg "Importing snppets from an XML file")
