...
if ( version_compare( $prev_version, $code_snippets->version, '<' ) ) {

	/* Update the plugin version stored in the database */
	update_option( 'code_snippets_version', $code_snippets->version );
}
...
if ( is_multisite() && is_main_site() ) {
	...
	/* Check if we have upgraded from an older version */
	if ( version_compare( $prev_ms_version, $code_snippets->version, '<' ) ) {

		/* Update the plugin version stored in the database */
		update_site_option( 'code_snippets_version', $code_snippets->version );
	}
