...
const parseStringArray = (value: unknown): string[] | undefined =>
  Array.isArray(value)
    ? value.filter((entry) => 'string' === typeof entry)
    : undefined
...
export const parseSnippetObject = (fields: unknown): Snippet => {
  const result: { -readonly [F in keyof Snippet]: Snippet[F] } = {
    ...defaults,
    tags: [],
  }
  ...
  return {
    ...
    ...('name' in fields &&
      'string' === typeof fields.name && { name: fields.name }),
    ...('desc' in fields &&
      'string' === typeof fields.desc && { desc: fields.desc }),
    ...('code' in fields &&
      'string' === typeof fields.code && { code: fields.code }),
    ...('tags' in fields && {
      tags: parseStringArray(fields.tags) ?? result.tags,
    }),
    ...('scope' in fields &&
      isValidScope(fields.scope) && { scope: fields.scope }),
    ...('modified' in fields &&
      'string' === typeof fields.modified && { modified: fields.modified }),
    ...('active' in fields &&
      'boolean' === typeof fields.active && { active: fields.active }),
    ...('network' in fields &&
      'boolean' === typeof fields.network && { network: fields.network }),
    ...('shared_network' in fields &&
      'boolean' === typeof fields.shared_network && {
        shared_network: fields.shared_network,
      }),
    ...('priority' in fields &&
      'number' === typeof fields.priority && { priority: fields.priority }),
    ...('condition_id' in fields &&
      isAbsInt(fields.condition_id) && { conditionId: fields.condition_id }),
