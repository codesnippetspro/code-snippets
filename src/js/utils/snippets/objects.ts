...
export const parseSnippetObject = (fields: unknown): Snippet => {
    ...
    ...'code_error' in fields && Array.isArray(fields.code_error) && fields.code_error.length === 2 && 'string' === typeof fields.code_error[0] && 'number' === typeof fields.code_error[1] && { code_error: fields.code_error as readonly [string, number] }
	}
}